                    ...
                    <div className="flex min-w-0 flex-1 flex-col">
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <button
                          ...
                          className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-lg text-slate-400 transition hover:bg-red-50 hover:text-red-600 sm:h-8 sm:w-8 sm:p-1.5"
                      ...
                      <div className="mt-3 flex items-center justify-between gap-2">
                        <div className="flex items-center rounded-lg border border-slate-300 bg-white">
                          <button
                            type="button"
                            className="inline-flex h-11 w-11 items-center justify-center text-slate-600 transition hover:text-teal-800 disabled:opacity-40 sm:h-8 sm:w-8 sm:p-2"
